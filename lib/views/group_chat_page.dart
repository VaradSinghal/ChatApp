...
import 'package:chatapp/constants/group_chat_message.dart';
import 'package:chatapp/constants/memberCalculate.dart';
...
import 'package:chatapp/providers/group_message_provider.dart';
  ...
  void _sendGroupMessage({
    ...
    await sendGroupMessage(
      ...
      if (value) {
        ...
        Provider.of<GroupMessageProvider>(
          context,
          listen: false,
        ).addGroupMessage(
          groupId: groupId,
